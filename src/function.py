...
def handler(event, context):
    ...
    slack_message = """
    @here A new video titled 'Message from %s_%s' was just uploaded to Youtube for Sponsorship: %s - Partner: %s. Please login to Youtube Studio to update translations at https://studio.youtube.com/channel/UCIqwpPyebBzHb0fgVPmtzpA/videos/upload
